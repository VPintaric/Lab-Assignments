...
public class SimpleHashtable {
	 ...
	 * to the equal or greater number than param capacity.
	...
	public SimpleHashtable(int capacity){
		...
		if(capacity <= 0){
			throw new HashException("Capacity of hashtable cannot be set to a negative number\n");
		}
		int i;
	...
	public void put(Object key, Object value){
		...
		if(key == null) throw new HashException("Key can't be null\n");
		...
		cur = table[slot];
		while(cur.next != null){
			if(hash == cur.key.hashCode()){   //if there already exists an entry with same hash
				cur.value = value;
				return;
			}
		}
	...
	public Object get(Object key){
		...
		if(key == null)
			throw new HashException("Argument of method get cannot be a null pointer\n");
	...
	public boolean containsKey(Object key){
		...
		if(key == null)
			throw new HashException("Argument for method containsKey cannot be a null pointer\n");
	...
	public void removeObject(Object key){
		...
		if(key == null)
			throw new HashException("Argument of method removeObject cannot be a null pointer\n");
